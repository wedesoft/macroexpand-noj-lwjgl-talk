...
\begin{frame}
  ...
  \begin{minipage}[t]{0.49\textwidth}
    \begin{center}
      ...
      realistic, spiritual successor to KSP
    \end{center}
  \end{minipage}
\end{frame}
...
\begin{frame}
  ...
  \begin{minipage}[t]{0.49\textwidth}
    \begin{center}
      ...
      realistic cockpit, fixed missions
    \end{center}
  \end{minipage}
\end{frame}
...
\begin{frame}[fragile]
  \pdfbookmark[2]{Perturbed Normal Vector}{moonnormal}
  \frametitle{Moon {-} Perturbed Normal Vector}
  \begin{minted}[]{glsl}
#version 130
