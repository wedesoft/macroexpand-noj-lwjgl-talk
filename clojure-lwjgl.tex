...
\begin{frame}
  ...
  \begin{minipage}[t]{0.49\textwidth}
    \begin{center}
      ...
      proprietary, realistic, demo available, early access
    \end{center}
  \end{minipage}
  \begin{minipage}[t]{0.49\textwidth}
    \begin{center}
...
\begin{frame}
  ...
  \begin{minipage}[t]{0.49\textwidth}
    \begin{center}
      ...
      proprietary, realistic, demo available, to be released
    \end{center}
  \end{minipage}
  \begin{minipage}[t]{0.49\textwidth}
    \begin{center}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \end{huge}\\
    \vspace{24pt}
    Thanks to Daniel Slutsky for organizing Macroexpand Noj!\\
    \vspace{24pt}
