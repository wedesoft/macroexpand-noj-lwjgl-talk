...
\begin{frame}
  \pdfbookmark[1]{Software Dependencies}{dependencies}
...
\begin{frame}[fragile]
  \pdfbookmark[1]{Rendering}{rendering}
  \pdfbookmark[2]{Dependencies}{renderingdeps}
  \frametitle{Rendering - Dependencies}
